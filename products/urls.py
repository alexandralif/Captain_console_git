...
urlpatterns = [
    ...
    path("order_nintendo_computer_by_name", views.order_nintendo_computer_by_name, name="order_nintendo_computer_by_name"),
    path("order_nintendo_computer_by_price", views.order_nintendo_computer_by_price, name="order_nintendo_computer_by_price"),
    path("order_gameboy_computer_by_name", views.order_gameboy_computer_by_name,name="order_gameboy_computer_by_name"),
    path("order_gameboy_computer_by_price", views.order_gameboy_computer_by_price, name="order_gameboy_computer_by_price"),
    path("order_playstation_computer_by_name", views.order_playstation_computer_by_name, name="order_playstation_computer_by_name"),
    path("order_playstation_computer_by_price", views.order_playstation_computer_by_price, name="order_playstation_computer_by_price"),
    path("order_xbox_computer_by_name", views.order_xbox_computer_by_name, name="order_xbox_computer_by_name"),
    path("order_xbox_computer_by_price", views.order_xbox_computer_by_price, name="order_xbox_computer_by_price"),
    ...
    path("nintendo_computers",views.get_nintendo_computers,name="get_nintendo_computers"),
    path("gameboy_computers",views.get_gameboy_computers,name="get_gameboy_computers"),
    path("playstation_computers",views.get_playstation_computers,name="get_playstation_computers"),
    path("xbox_computers",views.get_xbox_computers,name="get_xbox_computers")
]
